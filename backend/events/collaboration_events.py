...
def register_collaboration_events(event_emitter):
    def handle_new_chat_message(group_id, user_id, message):
        ...
        try:
            ...
            current_app.logger.info(f"New chat message in group {group_id} by user {user_id}: {message}")
        except Exception as e:
            current_app.logger.error(f"Error broadcasting chat message: {e}")
    ...
    def handle_proposal_created(proposal_id, user_id):
        ...
        try:
            ...
            current_app.logger.info(f"Proposal {proposal_id} created by user {user_id}")
        except Exception as e:
            current_app.logger.error(f"Error broadcasting proposal_created: {e}")
    ...
    def handle_investment_made(proposal_id, group_id, user_id, amount):
        ...
        try:
            ...
            current_app.logger.info(f"Investment of {amount} in group {group_id} for proposal {proposal_id} by user {user_id}")
        except Exception as e:
            current_app.logger.error(f"Error broadcasting investment_made: {e}")
    ...
    def handle_group_created(proposal_id, group_id, user_id):
        ...
        try:
            ...
            current_app.logger.info(f"Group {group_id} created for proposal {proposal_id} by user {user_id}")
        except Exception as e:
            current_app.logger.error(f"Error broadcasting group_created: {e}")
    ...
    def handle_vote_cast(group_id, user_id, proposal_option):
        ...
        try:
            ...
            current_app.logger.info(f"Vote cast in group {group_id} by user {user_id}: {proposal_option}")
        except Exception as e:
            current_app.logger.error(f"Error broadcasting vote_cast: {e}")
    ...
    def handle_proposal_status_updated(proposal_id, status):
        ...
        try:
            ...
            current_app.logger.info(f"Proposal {proposal_id} status updated to {status}")
        except Exception as e:
            current_app.logger.error(f"Error broadcasting proposal_status_updated: {e}")
    ...
    def handle_email_notification(user_id, email, subject, message):
        ...
        try:
            ...
            mail.send(msg)
            current_app.logger.info(f"Email notification sent to user {user_id} ({email}): {subject}")
        except Exception as e:
            current_app.logger.error(f"Failed to send email to user {user_id} ({email}): {e}")
    ...
    def handle_frontend_notification(user_id, group_id, message):
        ...
        try:
            ...
            current_app.logger.info(f"Frontend notification sent to user {user_id} (group {group_id}): {message}")
        except Exception as e:
            current_app.logger.error(f"Failed to send frontend notification to user {user_id}: {e}")
    ...
    current_app.logger.info("Collaboration and notification event handlers registered")